...
<section id="snorkeling" className="section snorkel-section">
 ...
 <div className="snorkel-lead"><div className="snorkel-copy"><p className="number-label">01 / 当天记录</p><h3>水肺潜水很好玩，<br/>浮潜感觉比较一般。</h3><p>行程在<strong>酒店对面的旅行社</strong>购买，三个人合计 10,000 泰铢，包含皇帝岛水肺潜水与珊瑚岛浮潜。</p><p>这次水肺是从岸边走到更深一些的位置；如果以后再去，更想尝试从船上出发、寻找鱼群的船潜。</p><div className="mini-facts"><span><Clock3 size={17}/> 9/22 一整天</span><span><Wallet size={17}/> ฿10,000／3 人</span></div></div>
