...
export const foodDays:FoodDay[] = [
  ...
  },
  {
    ...
    "note": "今天继续玩，下午 BACC 和 Siam，餐厅按想在哪一段吃来选；不用为了打卡重复吃同一家。",
    "meals": [
      {
        "name": "早餐",
        "options": [
  ...
  },
  {
    "date": "30",
    "city": "曼谷 → 杭州",
    "route": "Asok → BKK／DMK → HGH",
    "note": "三餐随航班调整。凌晨／早班机需将机场用餐前移到 9/29 晚，市区候选只在时间宽裕时适用。",
    "meals": [
      {
        "name": "早餐",
        "options": [
